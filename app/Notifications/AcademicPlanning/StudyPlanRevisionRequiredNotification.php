...
class StudyPlanRevisionRequiredNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'type' => 'study_plan_revision_required',
            ...
            'message' => 'Kế hoạch học tập cần chỉnh sửa theo góp ý CVHT.',
        ];
    }
}
