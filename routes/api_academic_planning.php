...
Route::prefix('v1/academic-planning')->middleware(['auth:sanctum'])->group(function (): void {
    Route::prefix('student')->group(function (): void {
        ...
        Route::post('study-plan-versions/{version}/items/validate', [StudentStudyPlanItemController::class, 'validateBeforeSave']);
    ...
    Route::prefix('dashboard')->group(function (): void {
        Route::get('student', [AcademicPlanningDashboardController::class, 'student']);
        Route::post('student/recompute', [AcademicPlanningDashboardController::class, 'queueRecompute']);
        Route::get('advisor', [AcademicPlanningDashboardController::class, 'advisor']);
        Route::get('registrar', [AcademicPlanningDashboardController::class, 'registrar']);
    });
});
